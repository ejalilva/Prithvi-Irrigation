...
N_GPUS = 1  # Number of GPUs per trial
...
def objective(trial):
    ...
    # Only use confusion matrix for promising trials
    ...
    try:
        ...
        model_args = {
            ...
            "necks": [
                {
                    "name": "SelectIndices",
                    "indices": [5, 11, 17, 23]  # for prithvi_eo_v2_300
                },
                {
...
def train_best_model(study):
    ...
    # Data module
    data_module = create_datamodule(batch_size=batch_size, num_workers=23)
